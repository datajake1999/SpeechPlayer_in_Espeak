...
# ADD LINK32 winmm.lib ..\PAStaticWMME\Release\PAStaticWMME.lib kernel32.lib advapi32.lib ole32.lib /nologo /subsystem:windows /dll /map /debug /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libcp" /pdbtype:sept /libpath:"..\..\..\..\lib\i386"
...
# ADD CPP /nologo /MT /W3 /Od /I "..\..\..\..\..\ddk\include" /I "..\..\..\..\include" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_ATL_STATIC_REGISTRY" /Yu"stdafx.h" /FD /c
# ADD MTL /I "..\..\..\..\..\ddk\idl" /I "..\..\..\..\idl"
...
# ADD LINK32 winmm.lib ..\PAStaticWMME\Release\PAStaticWMME.lib kernel32.lib advapi32.lib ole32.lib /nologo /subsystem:windows /dll /map /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libcp" /out:"Release_x86/espeak_sapi.dll" /libpath:"..\..\..\..\lib\i386"
# Begin Custom Build - Performing registration
OutDir=.\Release_x86
