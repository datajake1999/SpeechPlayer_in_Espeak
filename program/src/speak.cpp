...
"-r <integer>\n"
"\t   Pitch range, 0 to 100, default is 50, 0 is monotone, 100 is expressive\n"
"\t   Try a value of \"75\" for more natural inflection\n"
"-s <integer>\n"
...
{//=====================================================
...
#ifdef PLATFORM_WINDOWS
	{
		...
		sprintf(path_home, "%s%sespeak-data",driveLetter,directory);
		return;
	}
#else
#ifdef PLATFORM_DOS
...
{//========================
   ...
   setlocale(LC_CTYPE,"ISO8859-1");
	...
	static const char *arg_opts = "abfgklprsvw";  // which options have arguments
...
//		{"brief",   no_argument,       &verbose_flag, 0},
	...
	while(true)
	{
		c = getopt_long (argc, argv, "a:b:f:g:hk:l:p:r:qs:v:w:xXmz",   // NOTE: also change arg_opts to indicate which commands have a numeric value
	...
	if(pitch_range != 50)
	{
		SetParameter(espeakRANGE,pitch_range,0);
	}
	DoVoiceChange(voice);
