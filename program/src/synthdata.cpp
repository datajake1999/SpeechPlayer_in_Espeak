...
const char *version_string = "1.48.15  16.Apr.15 Custom\nSupport for adjusting pitch range has been added.\nNV speechPlayer is now used for the Implementation of Klatt.";
