...
CLEAN :
	...
	-@erase "$(OUTDIR)\espeak_lib.dll"
	-@erase "$(OUTDIR)\espeak_lib.exp"
	-@erase "$(OUTDIR)\espeak_lib.lib"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ESPEAK_EXPORTS" /Fp"$(INTDIR)\espeak.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=winmm.lib ..\PAStaticWMME\Release\PAStaticWMME.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\espeak_lib.pdb" /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libcp" /out:"$(OUTDIR)\espeak_lib.dll" /implib:"$(OUTDIR)\espeak_lib.lib" 
LINK32_OBJS= \
...
"$(OUTDIR)\espeak_lib.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(OUTDIR)\espeak_lib.dll"
	-@erase "$(OUTDIR)\espeak_lib.exp"
	-@erase "$(OUTDIR)\espeak_lib.ilk"
	-@erase "$(OUTDIR)\espeak_lib.lib"
	-@erase "$(OUTDIR)\espeak_lib.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ESPEAK_EXPORTS" /Fp"$(INTDIR)\espeak.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
LINK32=link.exe
LINK32_FLAGS=winmm.lib ..\PAStaticWMME\Release\PAStaticWMME.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\espeak_lib.pdb" /debug /machine:I386 /nodefaultlib:"libc" /nodefaultlib:"libcp" /out:"$(OUTDIR)\espeak_lib.dll" /implib:"$(OUTDIR)\espeak_lib.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\compiledict.obj" \
	"$(INTDIR)\dictionary.obj" \
	"$(INTDIR)\intonation.obj" \
...
"$(INTDIR)\speak_lib.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\espeak.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
CPP_SWITCHES=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ESPEAK_EXPORTS" /Fp"$(INTDIR)\espeak.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MTd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "ESPEAK_EXPORTS" /Fp"$(INTDIR)\espeak.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
